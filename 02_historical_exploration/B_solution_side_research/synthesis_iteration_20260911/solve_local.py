...
def solve_case(case_path, output, *, selection_path=None, policy="selected"):
    ...
    selection_path = selection_path or ROOT / "campaign/deployment_selection.json"
...
def main(argv=None):
    ...
    parser.add_argument("--selection", default=str(ROOT / "campaign/deployment_selection.json"),
