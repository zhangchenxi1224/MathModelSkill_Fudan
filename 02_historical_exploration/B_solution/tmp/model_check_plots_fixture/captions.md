...
- M01: fixture_joint__radius_0__noise_deterministic；组状态 insufficient_evidence；组记录 O5/L20。
- M02: fixture_joint__radius_1__noise_deterministic；组状态 insufficient_evidence；组记录 O5/L20。
- M03: fixture_joint__radius_2__noise_deterministic；组状态 insufficient_evidence；组记录 O5/L20。
- M04: fixture_joint__radius_3__noise_deterministic；组状态 insufficient_evidence；组记录 O5/L20。
- M05: fixture_joint__radius_4__noise_deterministic；组状态 insufficient_evidence；组记录 O5/L20。
- M06: fixture_joint__radius_5__noise_deterministic；组状态 insufficient_evidence；组记录 O5/L20。
