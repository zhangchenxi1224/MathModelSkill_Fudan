> **当前 P3/P4 入口。** 实际选择以 `release.json` 为准：P3=`current`，P4=`ring_search`。已完成P3、P4各3次正式测试，六局正常结束且6份日志均已上传；此前20局演练单独保留。
>
...
本目录独立于上一版 `log_guided_iteration_20260912`。算法、全部实验日志、新数据和旧基线统计都保留在此处；上一版没有被覆盖。已完成P3、P4各3次正式测试，六局正常结束且6份日志均已上传；此前20局演练单独保留。
...
[正式逐局成绩及案例编号](runs/formal_selected_3_each_20260912/report/results.md) · [可视化表格与耗时诊断](runs/formal_selected_3_each_20260912/report/results.html) · [官方上传记录](runs/formal_selected_3_each_20260912/upload_status.json) · [完整正式实验包（约1.70 MB）](https://github.com/zhangchenxi1224/MathModelSkill_Fudan/releases/tag/p3-p4-formal-6-20260912)
