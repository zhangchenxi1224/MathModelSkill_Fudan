# 数学建模 B 题：P3 / P4 搜索清除算法与实验归档

本仓库保存截至 **2026 年 9 月 12 日** 已实现的最新算法及全部历史探索。当前采用 **P3 局部两步前瞻**、**P4 三反馈成本决策**；最新算法与历史探索分别存放，便于阅读和复现。

**先读报告：** [PDF 阅读版](P3_P4_模型与算法实验报告.pdf) · [Word 可编辑版](P3_P4_模型与算法实验报告.docx) · [Markdown 原稿](P3_P4_模型与算法实验报告.md)

**下载全部资料：** [完整交付 Release](https://github.com/zhangchenxi1224/MathModelSkill_Fudan/releases/tag/p3-p4-delivery-20260912)。GitHub 的 **Code → Download ZIP 只下载网页仓库，不包含完整原始数据包**。
...
共同目标是在**完整发现、清除全部源，并取得没有遗漏的退出依据**之后，使整局总虚拟时间尽可能小：
